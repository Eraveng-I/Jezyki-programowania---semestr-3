...
public class PersonConsoleApp {
	...
	private static final String MENU = 
			...
			" 6 - Dodaj osobe do kolekcji Hashset    \n" +
			" 7 - Dodaj osobe do kolekcji Treeset    \n" +
			" 8 - Dodaj osobe do kolekcji ArrayList  \n" +
			" 9 - Dodaj osobe do kolekcji LinkedList \n" +
			"10 - Dodaj osobe do kolekcji HashMap    \n" +
			"11 - Dodaj osobe do kolekcji TreeMap    \n" +
			"12 - Usun osobe z kolekcji Hashset      \n" +
			"13 - Usun osobe z kolekcji Treeset      \n" +
			"14 - Usun osobe z kolekcji ArrayList    \n" +
			"15 - Usun osobe z kolekcji LinkedList   \n" +
			"16 - Usun osobe z kolekcji HashMap      \n" +
			"17 - Usun osobe z kolekcji TreeMap      \n" +
			"18 - Wypisz osoby z kolekcji            \n" +
			"0 - Zakończ program                     \n";
	...
	private static final Magazyn MD = new Magazyn();
	...
	public void runMainLoop() {
		...
		while (true) {
			...
			try {
				...
				case 6:
					// Dodanie osobe do kolekcji Hashset
					MD.dodajHashset(currentPerson);
					break;

				case 7:
					// Dodanie osobe do kolekcji Treeset
					MD.dodajTreeset(currentPerson);
					break;

				case 8:
					// Dodaj osobe do kolekcji ArrayList
					MD.dodajArray(currentPerson);
					break;

				case 9:
					// Dodaj osobe do kolekcji LinkedList
					MD.dodajLinked(currentPerson);
					break;

				case 15:
					// Dodaj osobe do kolekcji HashMap
					MD.dodajHashMap(currentPerson);
					break;

				case 16:
					// Dodaj osobe do kolekcji TreeMap
					MD.dodajTreeMap(currentPerson);
					break;

				case 10:
					// Usun osobe z kolekcji Hashset
					MD.usunHashset(currentPerson);
					break;

				case 11:
					// Usun osobe z kolekcji Treeset
					MD.usunTreeset(currentPerson);
					break;

				case 12:
					// Usun osobe z kolekcji ArrayList
					MD.usunArray(currentPerson);
					break;

				case 13:
					// Usun osobe z kolekcji LinkedList
					MD.usunLinked(currentPerson);
					break;

				case 17:
					// Usun osobe z kolekcji HashMap
					MD.usunHashMap(currentPerson);
					break;

				case 18:
					// Usun osobe z kolekcji TreeMap
					MD.usunTreeMap(currentPerson);
					break;


				case 14:
					// Wypisanie osob z kolekcji
					MD.WypiszOsobyWKolekcji();
					break;
